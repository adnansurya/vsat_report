...
if(!isset($_GET['id'])){
    ...
    $report_sql = mysqli_query($conn,"SELECT cust.nama as 'nama_cust', admin.nama as 'nama_admin' , tek.nama as 'nama_tek', report.* , error_list.kode_error, 
    dev1.device_name as nama_dev1 , dev2.device_name as nama_dev2, dev3.device_name as nama_dev3 
    FROM user cust, user admin, user tek, report, error_list, device dev1, device dev2, device dev3 WHERE 
    report.customer_id = cust.user_id AND 
    report.teknisi_id = tek.user_id AND 
    report.admin_id = admin.user_id AND 
    (report.error_id = error_list.id_error OR report.error_id = 0) AND
...
<div class="container-fluid">
    ...
    <div class="row mt-4 mb-4">
        <div class="container border printed" id="forPrint">
            ...
            <p id="errorTxt"><?php echo $report['kode_error']; ?></p>
